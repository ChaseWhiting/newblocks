...
import net.mcreator.newblocks.procedures.DestroyArrowsFletchingGUIProcedure;
import net.mcreator.newblocks.procedures.CheckIfTheItemIsTrueFletchingGUIProcedure;
...
public class FletchingGUIGui extends NewBlocksModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public FletchingGUIGui(NewBlocksModElements instance) {
		super(instance, 1756);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("fletching_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, FletchingGUIGuiWindow::new));
	}
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 26) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (Items.FLINT == stack.getItem());
				}
			}));
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 1) {
			...
			DestroyArrowsFletchingGUIProcedure.executeProcedure(Stream
	...
	private static void handleSlotAction(PlayerEntity entity, int slotID, int changeType, int meta, int x, int y, int z) {
		...
		if (slotID == 0 && changeType == 0) {
			...
			CheckIfTheItemIsTrueFletchingGUIProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
