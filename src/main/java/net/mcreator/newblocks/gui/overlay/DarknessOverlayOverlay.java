	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (DarknessOverlayDisplayOverlayIngameProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
				...
				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("new_blocks:textures/screens/darkness_overlay.png"));
				Minecraft.getInstance().ingameGUI.blit(event.getMatrixStack(), 0, 0, 0, 0, w, h, w, h);
				Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("new_blocks:textures/screens/darkness.png"));
