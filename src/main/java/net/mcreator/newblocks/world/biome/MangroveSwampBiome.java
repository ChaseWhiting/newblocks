...
public class MangroveSwampBiome extends NewBlocksModElements.ModElement {
	public static Biome biome;

	public MangroveSwampBiome(NewBlocksModElements instance) {
		super(instance, 1641);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-12944790).setWaterFogColor(-14474473)
						.withSkyColor(7972607).withFoliageColor(-7491289).withGrassColor(-9801671).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.SWAMP.func_242929_a(new SurfaceBuilderConfig(MudBlock.block.getDefaultState(),
								MudBlock.block.getDefaultState(), MudBlock.block.getDefaultState())));
				biomeGenerationSettings.withStructure(StructureFeatures.STRONGHOLD);
				biomeGenerationSettings.withStructure(StructureFeatures.MINESHAFT);
				biomeGenerationSettings.withStructure(StructureFeatures.SWAMP_HUT);
				biomeGenerationSettings.withStructure(StructureFeatures.RUINED_PORTAL_SWAMP);
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.DISK
								.withConfiguration(new SphereReplaceConfig(MudBlock.block.getDefaultState(), FeatureSpread.func_242253_a(4, 4), 2,
										ImmutableList.of(MudBlock.block.getDefaultState(), MudBlock.block.getDefaultState())))
				...
				mobSpawnInfo.withSpawner(EntityClassification.WATER_CREATURE, new MobSpawnInfo.Spawners(EntityType.TROPICAL_FISH, 1, 2, 4));
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.SWAMP).depth(-0.12f).scale(0.024f)
						.temperature(0.5f).downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("new_blocks:mangrove_swamp"));
			}
		}
	}
