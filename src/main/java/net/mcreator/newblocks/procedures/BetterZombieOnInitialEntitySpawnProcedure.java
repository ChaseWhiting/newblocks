...
public class BetterZombieOnInitialEntitySpawnProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		} else if (new Random().nextInt(10 + 1) == 3) {
			if (!entity.world.isRemote())
				entity.remove();
			if (world instanceof ServerWorld) {
		...
		} else if (new Random().nextInt(10 + 1) == 6) {
			if (!entity.world.isRemote())
				entity.remove();
			if (world instanceof ServerWorld) {
		...
		} else if (new Random().nextInt(10 + 1) == 7) {
			if (!entity.world.isRemote())
				entity.remove();
			if (world instanceof ServerWorld) {
		...
		} else if (new Random().nextInt(10 + 1) == 8) {
			if (!entity.world.isRemote())
				entity.remove();
			if (world instanceof ServerWorld) {
		...
		} else if (new Random().nextInt(10 + 1) == 9) {
			if (!entity.world.isRemote())
				entity.remove();
			if (world instanceof ServerWorld) {
		...
		} else if (new Random().nextInt(10 + 1) == 10) {
			if (!entity.world.isRemote())
				entity.remove();
			if (world instanceof ServerWorld) {
