...
public class ReProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
			((PlayerEntity) entity).sendStatusMessage(new StringTextComponent("\u00A7oCalling \u00A76\u00A7lMeteor Strike..."), (false));
		}
		LaunchStatus = (false);
		...
		if (LaunchStatus == true) {
			...
			if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
				((PlayerEntity) entity).sendStatusMessage(new StringTextComponent("\u00A78\u00A7nA meteor srtike is occuring nearby!"), (false));
			}
		}
	}
}
