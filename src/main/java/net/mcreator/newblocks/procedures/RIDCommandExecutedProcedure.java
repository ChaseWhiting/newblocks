...
public class RIDCommandExecutedProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		entity.getPersistentData().putDouble("ID1", (new Random().nextInt(9 + 1)));
		entity.getPersistentData().putDouble("ID2", (new Random().nextInt(9 + 1)));
		entity.getPersistentData().putDouble("ID3", (new Random().nextInt(9 + 1)));
		entity.getPersistentData().putDouble("ID4", (new Random().nextInt(9 + 1)));
		entity.getPersistentData().putDouble("ID5", (new Random().nextInt(9 + 1)));
		entity.getPersistentData().putDouble("ID6", (new Random().nextInt(9 + 1)));
		new Object() {
			private int ticks = 0;
