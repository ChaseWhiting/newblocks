...
public class SwordStandOnBlockRightClickedProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			world.setBlockState(new BlockPos(x, y, z), SwordStandThunderbladeBlock.block.getDefaultState(), 3);
			...
			world.setBlockState(new BlockPos(x, y, z), SwordStandFrostbladeBlock.block.getDefaultState(), 3);
		} else if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			world.setBlockState(new BlockPos(x, y, z), SwordStandFlamebladeBlock.block.getDefaultState(), 3);
		}
	}
}
