	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("immediatesourceentity") == null) {
			if (!dependencies.containsKey("immediatesourceentity"))
				NewBlocksMod.LOGGER.warn("Failed to load dependency immediatesourceentity for procedure SummonMeteor!");
			return;
		}
		...
		if (world.canBlockSeeSky(new BlockPos(x, y + 5, z))) {
			if (EnchantmentHelper.getEnchantmentLevel(MeteorEnchantment.enchantment,
				...
				if (immediatesourceentity instanceof ArrowEntity) {
