			...
			for (Entity entityiterator : _entfound) {
				if (!(entityiterator == entity)) {
					if (!((entityiterator instanceof TameableEntity && entity instanceof LivingEntity)
						...
						world.setBlockState(new BlockPos(entityiterator.getPosX(), entityiterator.getPosY(), entityiterator.getPosZ()),
								ThornsBlock.block.getDefaultState(), 3);
						world.setBlockState(new BlockPos(entityiterator.getPosX(), entityiterator.getPosY() + 1, entityiterator.getPosZ()),
								ThornsBlock.block.getDefaultState(), 3);
