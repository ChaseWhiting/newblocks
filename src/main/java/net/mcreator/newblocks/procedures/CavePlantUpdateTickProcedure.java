...
public class CavePlantUpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (Math.random() < 0.4) {
			if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == PurpleCavePlantLBlock.block) {
			...
			} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CavePlantBlock.block) {
				if (world.isAirBlock(new BlockPos(x, y - 1, z))) {
					{
						BlockPos _bp = new BlockPos(x, y - 1, z);
						BlockState _bs = CavePlantBlock.block.getDefaultState();
			...
			} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CavePlantLitBlock.block) {
				if (world.isAirBlock(new BlockPos(x, y - 1, z))) {
					{
						BlockPos _bp = new BlockPos(x, y - 1, z);
						BlockState _bs = CavePlantBlock.block.getDefaultState();
			...
			} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == RedCavePlantBottomBlock.block) {
				if (world.isAirBlock(new BlockPos(x, y - 1, z))) {
					{
						BlockPos _bp = new BlockPos(x, y - 1, z);
						BlockState _bs = CavePlantBlock.block.getDefaultState();
			...
			if (Math.random() < 0.4) {
				if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CavePlantBlock.block) {
					if (Math.random() < 0.7) {
						{
							BlockPos _bp = new BlockPos(x, y, z);
				...
				} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == CavePlantMiddleUnlitBlock.block) {
					if (Math.random() < 0.7) {
						{
							BlockPos _bp = new BlockPos(x, y, z);
							BlockState _bs = CavePlantMiddleLitBlock.block.getDefaultState();
