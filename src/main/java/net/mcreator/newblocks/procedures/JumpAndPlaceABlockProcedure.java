					...
					if (Math.random() < 0.7) {
						if (Math.random() < 0.7) {
							...
							new Object() {
								...
								private void run() {
									world.setBlockState(new BlockPos(NewBlocksModVariables.WorldVariables.get(world).varX, y - 1,
											NewBlocksModVariables.WorldVariables.get(world).varZ), Blocks.COBBLESTONE.getDefaultState(), 3);
