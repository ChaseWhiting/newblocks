...
public class SetToOneElseZeroProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (EnchantmentHelper.getEnchantmentLevel(LavaWalkingEnchantment.enchantment,
			...
			if ((world.getBlockState(new BlockPos(x + 1, y - 1, z))).getBlock() == Blocks.LAVA) {
				world.setBlockState(new BlockPos(x + 1, y - 1, z), Blocks.BASALT.getDefaultState(), 3);
				new Object() {
					private int ticks = 0;
					...
					private void run() {
						world.setBlockState(new BlockPos(x + 1, y - 1, z), Blocks.LAVA.getDefaultState(), 3);
			...
			if ((world.getBlockState(new BlockPos(x, y - 1, z + 1))).getBlock() == Blocks.LAVA) {
				world.setBlockState(new BlockPos(x, y - 1, z + 1), Blocks.BASALT.getDefaultState(), 3);
				new Object() {
					private int ticks = 0;
					private float waitTicks;
					private IWorld world;
					...
					private void run() {
						world.setBlockState(new BlockPos(x, y - 1, z + 1), Blocks.LAVA.getDefaultState(), 3);
						MinecraftForge.EVENT_BUS.unregister(this);
					}
				}.start(world, (int) 60);
			}
			...
			if ((world.getBlockState(new BlockPos(x - 1, y - 1, z - 1))).getBlock() == Blocks.LAVA) {
				world.setBlockState(new BlockPos(x - 1, y - 1, z - 1), Blocks.BASALT.getDefaultState(), 3);
				new Object() {
					private int ticks = 0;
					private float waitTicks;
					private IWorld world;
					...
					private void run() {
						world.setBlockState(new BlockPos(x - 1, y - 1, z - 1), Blocks.LAVA.getDefaultState(), 3);
						MinecraftForge.EVENT_BUS.unregister(this);
					}
				}.start(world, (int) 60);
			}
