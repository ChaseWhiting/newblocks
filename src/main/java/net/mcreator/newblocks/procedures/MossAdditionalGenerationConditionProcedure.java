...
public class MossAdditionalGenerationConditionProcedure {
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		...
		return (world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == Blocks.CAVE_AIR
				|| (world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == Blocks.STONE
				|| (world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == Blocks.GRANITE
				|| (world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == Blocks.DIORITE
				|| (world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == Blocks.ANDESITE;
	}
}
