...
public class LavaExtractorUpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		}.getEnergyStored(world, new BlockPos(x, y, z)) > 3500) {
		...
		if ((world.getBlockState(new BlockPos(x, y - 1, z))).getBlock() == Blocks.OBSIDIAN) {
			if ((new Object() {
			...
			}.getEnergyStored(world, new BlockPos(x, y, z)) > 400) {
				{
					TileEntity _ent = world.getTileEntity(new BlockPos(x, y, z));
					int _amount = (int) 350;
					if (_ent != null)
			...
			}.getEnergyStored(world, new BlockPos(x, y, z)) > 300) {
				{
					TileEntity _ent = world.getTileEntity(new BlockPos(x, y, z));
					int _amount = (int) 350;
					if (_ent != null)
