...
public class DeepDarkGrassUpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == Blocks.AIR) {
			world.setBlockState(new BlockPos(x, y, z), DormantDeepDarkGrassBlock.block.getDefaultState(), 3);
		} else if ((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == Blocks.POPPY) {
			world.setBlockState(new BlockPos(x, y, z), DeepDarkGrassBlock.block.getDefaultState(), 3);
		} else if ((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == Blocks.SUNFLOWER) {
			world.setBlockState(new BlockPos(x, y, z), DeepDarkGrassBlock.block.getDefaultState(), 3);
		} else if ((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == Blocks.DANDELION) {
			world.setBlockState(new BlockPos(x, y, z), DeepDarkGrassBlock.block.getDefaultState(), 3);
			...
			if (Math.random() >= 0.5) {
				if (!((world.getBlockState(new BlockPos(x + 1, y, z))).getBlock() == Blocks.AIR)) {
					if ((world.getBlockState(new BlockPos(x + 1, y, z))).getBlock() == Blocks.GRASS_BLOCK) {
						world.setBlockState(new BlockPos(x + 1, y, z), DeepDarkGrassBlock.block.getDefaultState(), 3);
					}
				}
			}
			if (Math.random() >= 0.5) {
			...
			if (Math.random() >= 0.5) {
				if (!((world.getBlockState(new BlockPos(x, y, z + 1))).getBlock() == Blocks.AIR)) {
					if ((world.getBlockState(new BlockPos(x, y, z + 1))).getBlock() == Blocks.GRASS_BLOCK) {
						world.setBlockState(new BlockPos(x, y, z + 1), DeepDarkGrassBlock.block.getDefaultState(), 3);
					}
				}
			}
			if (Math.random() >= 0.5) {
			...
			if (Math.random() >= 0.5) {
				if (!((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == Blocks.AIR)) {
					if ((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == Blocks.GRASS_BLOCK) {
						world.setBlockState(new BlockPos(x, y + 1, z), DeepDarkGrassBlock.block.getDefaultState(), 3);
					}
				}
			}
			if (Math.random() >= 0.5) {
			...
			if (Math.random() >= 0.5) {
				if (!((world.getBlockState(new BlockPos(x + 1, y + 1, z))).getBlock() == Blocks.AIR)) {
					if ((world.getBlockState(new BlockPos(x + 1, y + 1, z))).getBlock() == Blocks.GRASS_BLOCK) {
						world.setBlockState(new BlockPos(x + 1, y + 1, z), DeepDarkGrassBlock.block.getDefaultState(), 3);
					}
				}
			}
			if (Math.random() >= 0.5) {
			...
			if (Math.random() >= 0.5) {
				if (!((world.getBlockState(new BlockPos(x, y + 1, z + 1))).getBlock() == Blocks.AIR)) {
					if ((world.getBlockState(new BlockPos(x, y + 1, z + 1))).getBlock() == Blocks.GRASS_BLOCK) {
						world.setBlockState(new BlockPos(x, y + 1, z + 1), DeepDarkGrassBlock.block.getDefaultState(), 3);
					}
				}
			}
			if (Math.random() >= 0.5) {
