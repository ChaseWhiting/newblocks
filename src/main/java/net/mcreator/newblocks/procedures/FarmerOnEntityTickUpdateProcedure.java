...
public class FarmerOnEntityTickUpdateProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(entity.getPosX(), entity.getPosY() - 1, entity.getPosZ()))).getBlock() == Blocks.FARMLAND) {
			if ((world.getBlockState(new BlockPos(entity.getPosX(), entity.getPosY() + 1, entity.getPosZ()))).getBlock() == Blocks.AIR) {
				world.setBlockState(new BlockPos(entity.getPosX(), entity.getPosY(), entity.getPosZ()), TomatoSeedsBlock.block.getDefaultState(), 3);
				if (entity instanceof LivingEntity) {
