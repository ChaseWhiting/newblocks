...
import net.mcreator.newblocks.procedures.PalmLeavesUpdateTickProcedure;
import net.mcreator.newblocks.procedures.PalmLeavesBlockDestroyedByPlayerProcedure;
...
public class PalmLeavesBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:palm_leaves")
	public static final Block block = null;

	public PalmLeavesBlock(NewBlocksModElements instance) {
		super(instance, 1724);
	...
	public static class CustomBlock extends LeavesBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			PalmLeavesUpdateTickProcedure.executeProcedure(Stream
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			PalmLeavesBlockDestroyedByPlayerProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			return retval;
