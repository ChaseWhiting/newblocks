...
import net.mcreator.newblocks.procedures.SculkSproutUpdateTickProcedure;
import net.mcreator.newblocks.procedures.SculkSproutClientDisplayRandomTickProcedure;
...
public class SculkSproutBlock extends NewBlocksModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			SculkSproutUpdateTickProcedure.executeProcedure(Stream
		...
		public void animateTick(BlockState blockstate, World world, BlockPos pos, Random random) {
			...
			SculkSproutClientDisplayRandomTickProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
