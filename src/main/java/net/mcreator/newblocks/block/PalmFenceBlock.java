...
public class PalmFenceBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:palm_fence")
	public static final Block block = null;

	public PalmFenceBlock(NewBlocksModElements instance) {
		super(instance, 1720);
	}
