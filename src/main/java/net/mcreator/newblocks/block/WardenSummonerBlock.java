...
public class WardenSummonerBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:warden_summoner")
	public static final Block block = null;

	public WardenSummonerBlock(NewBlocksModElements instance) {
		super(instance, 1772);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("warden_summoner");
		}
