...
public class PalmFenceGateBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:palm_fence_gate")
	public static final Block block = null;

	public PalmFenceGateBlock(NewBlocksModElements instance) {
		super(instance, 1721);
	}
