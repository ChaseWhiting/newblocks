...
public class PalmStairsBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:palm_stairs")
	public static final Block block = null;

	public PalmStairsBlock(NewBlocksModElements instance) {
		super(instance, 1717);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2f, 3f).setLightLevel(s -> 0)
					...
					Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(2f, 3f).setLightLevel(s -> 0).notSolid()
