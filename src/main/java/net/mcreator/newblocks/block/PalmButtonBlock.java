...
public class PalmButtonBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:palm_button")
	public static final Block block = null;

	public PalmButtonBlock(NewBlocksModElements instance) {
		super(instance, 1719);
	}
