...
public class Coconut2Block extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:coconut_2")
	public static final Block block = null;

	public Coconut2Block(NewBlocksModElements instance) {
		super(instance, 1744);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CoconutSliceItem.block, (int) (2)));
		}
