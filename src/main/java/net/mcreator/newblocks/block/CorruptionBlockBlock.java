...
public class CorruptionBlockBlock extends NewBlocksModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK, MaterialColor.RED).sound(SoundType.NETHERRACK)
					.hardnessAndResistance(0.7000000000000001f, 10f).setLightLevel(s -> 0).harvestLevel(1).harvestTool(ToolType.PICKAXE)
					.setRequiresTool());
