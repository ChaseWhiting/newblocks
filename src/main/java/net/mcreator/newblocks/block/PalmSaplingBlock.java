...
import net.mcreator.newblocks.procedures.PalmSaplingUpdateTickProcedure;
...
public class PalmSaplingBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:palm_sapling")
	public static final Block block = null;

	public PalmSaplingBlock(NewBlocksModElements instance) {
		super(instance, 1740);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == Blocks.SAND || ground == Blocks.GRASS_BLOCK || ground == Blocks.DIRT
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			PalmSaplingUpdateTickProcedure.executeProcedure(Stream
