...
public class PalmPlanksBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:palm_planks")
	public static final Block block = null;

	public PalmPlanksBlock(NewBlocksModElements instance) {
		super(instance, 1716);
	}
