...
import net.mcreator.newblocks.procedures.PitchblendeOreUpdateTickProcedure;
import net.mcreator.newblocks.procedures.PitchblendeOrePlayerStartsToDestroyProcedure;
...
public class PitchblendeOreBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:pitchblende_ore")
	public static final Block block = null;

	public PitchblendeOreBlock(NewBlocksModElements instance) {
		super(instance, 1937);
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			PitchblendeOrePlayerStartsToDestroyProcedure.executeProcedure(Stream
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			PitchblendeOreUpdateTickProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			world.getPendingBlockTicks().scheduleTick(pos, this, 20);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("new_blocks:pitchblende_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("pitchblende_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("new_blocks:pitchblende_ore"), configuredFeature);
		}
	}
