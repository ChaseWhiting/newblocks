...
public class PalmTrapdoorBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:palm_trapdoor")
	public static final Block block = null;

	public PalmTrapdoorBlock(NewBlocksModElements instance) {
		super(instance, 1722);
	}
