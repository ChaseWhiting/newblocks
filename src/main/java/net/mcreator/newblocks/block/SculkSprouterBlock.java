...
import net.mcreator.newblocks.procedures.SculkSprouterUpdateTickProcedure;
...
public class SculkSprouterBlock extends NewBlocksModElements.ModElement {
	@ObjectHolder("new_blocks:sculk_sprouter")
	public static final Block block = null;

	public SculkSprouterBlock(NewBlocksModElements instance) {
		super(instance, 1533);
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.MINING_FATIGUE, 8,
					Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.PLANT)
							...
							.setLightLevel(s -> 7));
			setRegistryName("sculk_sprouter");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SculkSproutBlock.block));
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			SculkSprouterUpdateTickProcedure.executeProcedure(Stream
