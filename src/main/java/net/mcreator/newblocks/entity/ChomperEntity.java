...
import net.mcreator.newblocks.procedures.ChomperOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.entity.renderer.ChomperRenderer;
...
public class ChomperEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.7f)).build("chomper").setRegistryName("chomper");

	public ChomperEntity(NewBlocksModElements instance) {
		super(instance, 1434);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ChomperRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9299032, -15504850, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("chomper_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void baseTick() {
			...
			ChomperOnEntityTickUpdateProcedure.executeProcedure(Stream
