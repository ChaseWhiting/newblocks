...
import net.mcreator.newblocks.procedures.PhoenixRightClickedOnEntityProcedure;
import net.mcreator.newblocks.procedures.PhoenixOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.procedures.PhoenixNaturalEntitySpawningConditionProcedure;
import net.mcreator.newblocks.entity.renderer.PhoenixRenderer;
...
public class PhoenixEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.7999999999999999f, 1.8f)).build("phoenix").setRegistryName("phoenix");

	public PhoenixEntity(NewBlocksModElements instance) {
		super(instance, 1501);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PhoenixRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -5627615, -4831965, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("phoenix_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return PhoenixNaturalEntitySpawningConditionProcedure.executeProcedure(Stream
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new TemptGoal(this, 1, Ingredient.fromItems(Blocks.CRIMSON_FUNGUS.asItem()), true));
			this.goalSelector.addGoal(5, new AvoidEntityGoal(this, PlayerEntity.class, (float) 8, 1.1, 1.3));
			this.goalSelector.addGoal(6, new AvoidEntityGoal(this, ZoglinEntity.class, (float) 14, 1.2, 1.5));
			this.goalSelector.addGoal(7, new AvoidEntityGoal(this, IronGolemEntity.class, (float) 16, 1.2, 1.5));
			this.goalSelector.addGoal(8, new LookRandomlyGoal(this));
			this.goalSelector.addGoal(9, new FindLavaGoal(this));
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			PhoenixRightClickedOnEntityProcedure.executeProcedure(Stream
