...
import net.mcreator.newblocks.procedures.SealOnInitialEntitySpawnProcedure;
import net.mcreator.newblocks.procedures.SealOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.entity.renderer.BabySealRenderer;
...
public class BabySealEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.7f, 0.4f)).build("baby_seal").setRegistryName("baby_seal");

	public BabySealEntity(NewBlocksModElements instance) {
		super(instance, 1550);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BabySealRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3089948, -7296076, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("baby_seal_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, CodEntity.class, false, false));
			this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, SalmonEntity.class, false, false));
			this.goalSelector.addGoal(3, new RandomSwimmingGoal(this, 10, 40));
			this.goalSelector.addGoal(4, new MeleeAttackGoal(this, 10, false) {
				@Override
				protected double getAttackReachSqr(LivingEntity entity) {
					return (double) (4.0 + entity.getWidth() * entity.getWidth());
				}
			});
			this.goalSelector.addGoal(5, new BreakBlockGoal(Blocks.SEA_PICKLE, this, 1.4, (int) 30));
			this.goalSelector.addGoal(6, new BreakBlockGoal(Blocks.SEAGRASS, this, 1.4, (int) 30));
			this.goalSelector.addGoal(7, new BreakBlockGoal(Blocks.TALL_SEAGRASS, this, 1.4, (int) 30));
			this.goalSelector.addGoal(8, new RandomWalkingGoal(this, 0.3));
			this.goalSelector.addGoal(9, new PanicGoal(this, 0.42));
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			SealOnInitialEntitySpawnProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		public void baseTick() {
			...
			SealOnEntityTickUpdateProcedure.executeProcedure(Stream
