...
import net.mcreator.newblocks.item.RawRainbowFishItem;
import net.mcreator.newblocks.entity.renderer.RainbowfishRenderer;
import net.mcreator.newblocks.NewBlocksModElements;
import net.minecraft.entity.CreatureEntity;
import net.minecraft.entity.passive.fish.SalmonEntity;

@NewBlocksModElements.ModElement.Tag
public class RainbowfishEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.5f, 0.4f)).build("rainbowfish").setRegistryName("rainbowfish");

	public RainbowfishEntity(NewBlocksModElements instance) {
		super(instance, 1554);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RainbowfishRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("rainbowfish_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 7, 4, 5));
	}
	...
	public static class CustomEntity extends SalmonEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new AvoidEntityGoal(this, PlayerEntity.class, (float) 3, 1, 1.2));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(RawRainbowFishItem.block));
		}
