...
import net.mcreator.newblocks.entity.renderer.SCP0585Renderer;
...
public class SCP0585Entity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.5f, 1.5f)).build("scp_0585").setRegistryName("scp_0585");

	public SCP0585Entity(NewBlocksModElements instance) {
		super(instance, 1656);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SCP0585Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("scp_0585_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, AnimalEntity.class, true, false));
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, PlayerEntity.class, false, false));
			this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, PillagerEntity.class, false, false));
			this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, CaveSpiderEntity.class, false, false));
			this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, StrayEntity.class, false, false));
			this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, SpiderEntity.class, false, false));
			this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, SkeletonEntity.class, false, false));
			this.goalSelector.addGoal(12, new MeleeAttackGoal(this, 1.21, false) {
				@Override
				protected double getAttackReachSqr(LivingEntity entity) {
					return (double) (4.0 + entity.getWidth() * entity.getWidth());
				}
			});
			this.goalSelector.addGoal(13, new LeapAtTargetGoal(this, (float) 0.67));
			this.goalSelector.addGoal(14, new RandomWalkingGoal(this, 0.8));
			this.targetSelector.addGoal(15, new HurtByTargetGoal(this).setCallsForHelp());
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			SCP0585RangeItem.shoot(this, target);
		}
