...
import net.mcreator.newblocks.entity.renderer.SeaUrchinRedRenderer;
...
public class SeaUrchinRedEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.4f, 0.3f)).build("sea_urchin_red").setRegistryName("sea_urchin_red");

	public SeaUrchinRedEntity(NewBlocksModElements instance) {
		super(instance, 1819);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SeaUrchinRedRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("sea_urchin_red_spawn_egg"));
	}
