...
import net.mcreator.newblocks.entity.renderer.ThreepeaterRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class ThreepeaterEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.9f, 1.5f)).build("threepeater").setRegistryName("threepeater");

	public ThreepeaterEntity(NewBlocksModElements instance) {
		super(instance, 1461);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ThreepeaterRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13588454, -14510778, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("threepeater_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ARMOR, 2.4);
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(1, new RangedAttackGoal(this, 0, 8, 10) {
				@Override
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			ThreepeaterBallItem.shoot(this, target);
		}
	}
}
