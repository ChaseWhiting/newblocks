...
import net.mcreator.newblocks.item.PeaShooterBallItem;
import net.mcreator.newblocks.entity.renderer.PeashooterRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class PeashooterEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.4000000000000001f)).build("peashooter").setRegistryName("peashooter");

	public PeashooterEntity(NewBlocksModElements instance) {
		super(instance, 1443);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PeashooterRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(1, new RangedAttackGoal(this, 0, 27, 10) {
				@Override
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			PeaShooterBallItem.shoot(this, target);
		}
	}
}
