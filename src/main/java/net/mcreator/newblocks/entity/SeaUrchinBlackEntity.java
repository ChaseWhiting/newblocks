...
import net.mcreator.newblocks.entity.renderer.SeaUrchinBlackRenderer;
...
public class SeaUrchinBlackEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.4f, 0.3f)).build("sea_urchin_black").setRegistryName("sea_urchin_black");

	public SeaUrchinBlackEntity(NewBlocksModElements instance) {
		super(instance, 1820);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SeaUrchinBlackRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("sea_urchin_black_spawn_egg"));
	}
