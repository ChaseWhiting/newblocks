...
import net.mcreator.newblocks.procedures.OarFishEntitySpawnsProcedure;
import net.mcreator.newblocks.procedures.GiantOarFishOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.item.RawGiantOarfishItem;
import net.mcreator.newblocks.entity.renderer.GiantOarFishRenderer;
...
public class GiantOarFishEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.2999999999999998f, 0.6f)).build("giant_oar_fish").setRegistryName("giant_oar_fish");

	public GiantOarFishEntity(NewBlocksModElements instance) {
		super(instance, 1563);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GiantOarFishRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9345678, -4380118, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("giant_oar_fish_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 4, 4, 7));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(RawGiantOarfishItem.block));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			OarFishEntitySpawnsProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		public void baseTick() {
			...
			GiantOarFishOnEntityTickUpdateProcedure.executeProcedure(Stream
