...
import net.mcreator.newblocks.procedures.IsTamedProcedureProcedure;
import net.mcreator.newblocks.procedures.IfIsRiddenAttackProcedure;
import net.mcreator.newblocks.entity.renderer.PhoenixSaddledRenderer;
...
public class PhoenixSaddledEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.8f, 1.8f)).build("phoenix_saddled").setRegistryName("phoenix_saddled");

	public PhoenixSaddledEntity(NewBlocksModElements instance) {
		super(instance, 1505);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PhoenixSaddledRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -5627615, -4831965, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("phoenix_saddled_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(3, new HurtByTargetGoal(this) {
				...
				public boolean shouldExecute() {
					...
					return super.shouldExecute()
							&& IfIsRiddenAttackProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
									.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
				}
			}.setCallsForHelp(this.getClass()));
			this.goalSelector.addGoal(4, new MeleeAttackGoal(this, 1, false));
			this.goalSelector.addGoal(5, new BreedGoal(this, 1.3));
			this.goalSelector.addGoal(6, new TemptGoal(this, 1, Ingredient.fromItems(Blocks.CRIMSON_FUNGUS.asItem()), true));
			this.goalSelector.addGoal(7, new AvoidEntityGoal(this, PlayerEntity.class, (float) 8, 1.1, 1.3) {
				@Override
				public boolean shouldExecute() {
					double x = CustomEntity.this.getPosX();
					double y = CustomEntity.this.getPosY();
					...
					Entity entity = CustomEntity.this;
					return super.shouldExecute()
							&& IsTamedProcedureProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
									.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
				}
			...
			this.goalSelector.addGoal(8, new AvoidEntityGoal(this, ZoglinEntity.class, (float) 14, 1.2, 1.5));
			this.goalSelector.addGoal(9, new AvoidEntityGoal(this, IronGolemEntity.class, (float) 16, 1.2, 1.5));
			this.goalSelector.addGoal(10, new LookRandomlyGoal(this));
			this.goalSelector.addGoal(11, new FindLavaGoal(this));
		}
