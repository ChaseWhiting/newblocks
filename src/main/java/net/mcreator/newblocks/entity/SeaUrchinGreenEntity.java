...
import net.mcreator.newblocks.entity.renderer.SeaUrchinGreenRenderer;
...
public class SeaUrchinGreenEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.4f, 0.3f)).build("sea_urchin_green").setRegistryName("sea_urchin_green");

	public SeaUrchinGreenEntity(NewBlocksModElements instance) {
		super(instance, 1817);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SeaUrchinGreenRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("sea_urchin_green_spawn_egg"));
	}
