...
import net.mcreator.newblocks.entity.renderer.SeaUrchinPurpleRenderer;
...
public class SeaUrchinPurpleEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.4f, 0.3f)).build("sea_urchin_purple").setRegistryName("sea_urchin_purple");

	public SeaUrchinPurpleEntity(NewBlocksModElements instance) {
		super(instance, 1816);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SeaUrchinPurpleRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("sea_urchin_purple_spawn_egg"));
	}
