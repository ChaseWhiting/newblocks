...
import net.mcreator.newblocks.procedures.SeaUrchinPurpleOnEntityTickUpdateProcedure;
import net.mcreator.newblocks.procedures.SeaUrchinBlackEntityIsHurtProcedure;
import net.mcreator.newblocks.entity.renderer.SeaUrchinYellowRenderer;
...
public class SeaUrchinYellowEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.WATER_CREATURE)
			...
			.size(0.4f, 0.3f)).build("sea_urchin_yellow").setRegistryName("sea_urchin_yellow");

	public SeaUrchinYellowEntity(NewBlocksModElements instance) {
		super(instance, 1818);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SeaUrchinYellowRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("sea_urchin_yellow_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 7, 2, 3));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new AvoidEntityGoal(this, PlayerEntity.class, (float) 2, 1, 1.2));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:entity.crab.ambient"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:entity.crab.hurt"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("new_blocks:entity.crab.death"));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			SeaUrchinBlackEntityIsHurtProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("sourceentity", sourceentity))
		...
		public void baseTick() {
			...
			SeaUrchinPurpleOnEntityTickUpdateProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
