...
import net.mcreator.newblocks.entity.renderer.PenguinRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class PenguinEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.52f, 0.86f)).build("penguin").setRegistryName("penguin");

	public PenguinEntity(NewBlocksModElements instance) {
		super(instance, 1553);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -15593456, -2236974, new Item.Properties().group(ItemGroup.MISC))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.AMBIENT).add(new MobSpawnInfo.Spawners(entity, 10, 1, 2));
	}
