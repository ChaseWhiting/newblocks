...
@OnlyIn(Dist.CLIENT)
public class AngryNewspaperZombieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(AngryNewspaperZombieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelnewspaper_zombie_angry(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/entities/newspaper_zombie_angry.png");
					}
				};
			});
		}
