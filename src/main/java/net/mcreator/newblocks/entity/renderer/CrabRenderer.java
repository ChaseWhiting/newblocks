...
public class CrabRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(CrabEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelcrab_new(), 0.4f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/crab_new.png");
					}
				};
			});
		}
	...
	public static class Modelcrab_new extends EntityModel<Entity> {
		...
		public void setRotationAngles(Entity e, float f, float f1, float f2, float f3, float f4) {
			...
			this.patte_L_4.rotateAngleX = MathHelper.cos(f * 0.8F) * 1.0F * f1;
			this.patte_L_3.rotateAngleX = MathHelper.cos(f * 0.6F) * 1.0F * f1;
			this.patte_L_2.rotateAngleX = MathHelper.cos(f * 0.3F) * 1.0F * f1;
			this.patte_R_1.rotateAngleX = MathHelper.cos(f * 1.0F) * 1.0F * f1;
			this.patte_R_4.rotateAngleX = MathHelper.cos(f * 0.8F) * 1.0F * f1;
			this.patte_R_3.rotateAngleX = MathHelper.cos(f * 0.6F) * 1.0F * f1;
			this.patte_R_2.rotateAngleX = MathHelper.cos(f * 0.3F) * 1.0F * f1;
