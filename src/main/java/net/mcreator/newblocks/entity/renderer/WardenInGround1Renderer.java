...
import net.mcreator.newblocks.entity.WardenInGround1Entity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class WardenInGround1Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WardenInGround1Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwarden_in_ground_1(), 1.4f) {
