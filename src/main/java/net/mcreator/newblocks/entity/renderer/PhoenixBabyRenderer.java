...
@OnlyIn(Dist.CLIENT)
public class PhoenixBabyRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PhoenixBabyEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelphoenix_baby(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/phoenix_baby.png");
					}
				};
			});
		}
