...
@OnlyIn(Dist.CLIENT)
public class VultureRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(VultureEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelvulture_land(), 0.4f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/entities/vulture_land.png");
					}
				};
			});
		}
	...
	public static class Modelvulture_land extends EntityModel<Entity> {
		...
		public Modelvulture_land() {
			textureWidth = 80;
			textureHeight = 80;
			body = new ModelRenderer(this);
			body.setRotationPoint(0.0F, 14.75F, 1.0F);
			...
			setRotationAngle(right_wing, 0.0F, 0.9163F, -0.7418F);
			...
			setRotationAngle(left_wing, 0.0F, -0.9163F, 0.7418F);
			...
			setRotationAngle(right_leg_r1, -0.9163F, 0.0F, 0.0F);
			...
			setRotationAngle(left_leg_r1, -0.9163F, 0.0F, 0.0F);
