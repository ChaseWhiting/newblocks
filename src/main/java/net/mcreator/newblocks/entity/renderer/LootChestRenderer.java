...
@OnlyIn(Dist.CLIENT)
public class LootChestRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(LootChestEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelloot_chest(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/entities/loot_chest.png");
					}
				};
			});
		}
