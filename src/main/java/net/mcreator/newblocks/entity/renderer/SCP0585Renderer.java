...
@OnlyIn(Dist.CLIENT)
public class SCP0585Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SCP0585Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelscp058_5(), 0.53f) {
