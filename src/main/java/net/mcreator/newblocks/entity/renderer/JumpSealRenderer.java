...
@OnlyIn(Dist.CLIENT)
public class JumpSealRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(JumpSealEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelseal_jumping(), 0.5f) {
