...
@OnlyIn(Dist.CLIENT)
public class SCP0583Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SCP0583Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelscp058_3_2(), 0.53f) {
