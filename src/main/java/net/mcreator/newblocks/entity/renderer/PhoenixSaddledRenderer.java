...
@OnlyIn(Dist.CLIENT)
public class PhoenixSaddledRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PhoenixSaddledEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelphoenix_riding(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/phoenix_riding.png");
					}
				};
			});
		}
