...
@OnlyIn(Dist.CLIENT)
public class ZhoemnixRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ZhoemnixEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelphoenix(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/zhoemnix.png");
					}
				};
			});
		}
	...
	public static class Modelphoenix extends EntityModel<Entity> {
		...
		public void setRotationAngles(Entity e, float f, float f1, float f2, float f3, float f4) {
			...
			this.hair_right_bottom.rotateAngleZ = MathHelper.cos(f * 0.08F) * 0.3F * f1;
			this.left_leg.rotateAngleX = MathHelper.cos(f * 1.0F) * -0.6F * f1;
			this.hair_right_top.rotateAngleZ = MathHelper.cos(f * 0.012F) * 0.3F * f1;
			this.hair_left_bottom.rotateAngleZ = MathHelper.cos(f * 0.08F) * -0.3F * f1;
			...
			this.hair_left_top.rotateAngleZ = MathHelper.cos(f * 0.012F) * -0.3F * f1;
		}
	}
