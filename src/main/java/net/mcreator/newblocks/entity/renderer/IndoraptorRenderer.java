...
@OnlyIn(Dist.CLIENT)
public class IndoraptorRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IndoraptorEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelIndoraptor(), 0.9f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/entities/indoraptor.png");
					}
				};
			});
		}
