...
import net.mcreator.newblocks.entity.PhoenixEntity;
...
public class PhoenixRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PhoenixEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelphoenix(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("new_blocks:textures/strider.png");
					}
				};
			});
		}
	...
	public static class Modelphoenix extends EntityModel<Entity> {
		...
		public Modelphoenix() {
			...
			body.setTextureOffset(0, 117).addBox(-5.5F, -6.0F, -2.0F, 11.0F, 2.0F, 9.0F, 0.0F, false);
			...
			bone11.setTextureOffset(40, 108).addBox(9.5F, -35.0F, -16.0F, 0.0F, 6.0F, 14.0F, 0.0F, false);
			bone5 = new ModelRenderer(this);
			bone5.setRotationPoint(-1.0F, 28.0F, 0.0F);
			saddle.addChild(bone5);
			setRotationAngle(bone5, 0.0F, -0.3491F, 0.0F);
			bone5.setTextureOffset(40, 108).addBox(-9.2F, -35.0F, -18.7F, 0.0F, 6.0F, 14.0F, 0.0F, false);
		...
		public void setRotationAngles(Entity e, float f, float f1, float f2, float f3, float f4) {
			this.right_leg.rotateAngleX = MathHelper.cos(f * 1.0F) * 0.6F * f1;
			this.right_leg.rotateAngleZ = MathHelper.cos(f * 0.1F) * 0.2F * f1;
			this.hair_right_bottom.rotateAngleZ = MathHelper.cos(f * 0.08F) * 0.1F * f1;
			this.left_leg.rotateAngleX = MathHelper.cos(f * 1.0F) * -0.6F * f1;
			this.left_leg.rotateAngleZ = MathHelper.cos(f * 0.1F) * 0.1F * f1;
			this.hair_right_top.rotateAngleZ = MathHelper.cos(f * 0.012F) * 0.1F * f1;
			this.hair_left_bottom.rotateAngleZ = MathHelper.cos(f * 0.08F) * -0.1F * f1;
			...
			this.bone11.rotateAngleY = f3 / (180F / (float) Math.PI);
			this.bone11.rotateAngleX = f4 / (180F / (float) Math.PI);
			this.hair_left_top.rotateAngleZ = MathHelper.cos(f * 0.012F) * -0.1F * f1;
			this.hair_left_top.rotateAngleZ = MathHelper.cos(f * 0.1F) * 0.1F * f1;
			this.hair_left_top.rotateAngleX = MathHelper.cos(f * 0.1F) * 0.1F * f1;
			this.hair_right_top.rotateAngleZ = MathHelper.cos(f * 0.1F) * 0.1F * f1;
			this.hair_right_top.rotateAngleX = MathHelper.cos(f * 0.1F) * 0.1F * f1;
			this.hair_right_bottom.rotateAngleZ = MathHelper.cos(f * 0.1F) * 0.1F * f1;
			this.hair_right_bottom.rotateAngleX = MathHelper.cos(f * 0.1F) * 0.1F * f1;
			this.hair_left_bottom.rotateAngleZ = MathHelper.cos(f * 0.1F) * 0.1F * f1;
			this.hair_left_bottom.rotateAngleX = MathHelper.cos(f * 0.1F) * 0.1F * f1;
			this.body.rotateAngleZ = MathHelper.cos(f * 0.1F) * 0.1F * f1;
			this.body.rotateAngleX = MathHelper.cos(f * 0.1F) * 0.1F * f1;
		}
	}
