...
import net.mcreator.newblocks.procedures.WardenShakeTestEntityShakingConditionProcedure;
import net.mcreator.newblocks.entity.WardenShakeTestEntity;
...
@OnlyIn(Dist.CLIENT)
public class WardenShakeTestRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WardenShakeTestEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwarden(), 1.4f) {
					...
					protected boolean func_230495_a_(LivingEntity _ent) {
						...
						return WardenShakeTestEntityShakingConditionProcedure.executeProcedure(Collections.EMPTY_MAP);
					}
				};
			});
		}
