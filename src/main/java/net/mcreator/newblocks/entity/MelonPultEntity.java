...
import net.mcreator.newblocks.item.MelonBallItem;
import net.mcreator.newblocks.entity.renderer.MelonPultRenderer;
import net.mcreator.newblocks.NewBlocksModElements;

@NewBlocksModElements.ModElement.Tag
public class MelonPultEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.8f, 1.4f)).build("melon_pult").setRegistryName("melon_pult");

	public MelonPultEntity(NewBlocksModElements instance) {
		super(instance, 1464);
		FMLJavaModLoadingContext.get().getModEventBus().register(new MelonPultRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14387947, -16415955, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("melon_pult_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(1, new RangedAttackGoal(this, 0, 35, 10) {
				@Override
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			MelonBallItem.shoot(this, target);
		}
	}
}
