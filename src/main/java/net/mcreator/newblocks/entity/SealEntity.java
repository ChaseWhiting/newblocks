...
import net.mcreator.newblocks.procedures.SealRightClickedOnEntityProcedure;
...
import net.mcreator.newblocks.entity.renderer.SealRenderer;
...
public class SealEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.7f, 0.4f)).build("seal").setRegistryName("seal");

	public SealEntity(NewBlocksModElements instance) {
		super(instance, 1543);
		FMLJavaModLoadingContext.get().getModEventBus().register(new SealRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -3089948, -7296076, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("seal_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			SealRightClickedOnEntityProcedure.executeProcedure(Stream
