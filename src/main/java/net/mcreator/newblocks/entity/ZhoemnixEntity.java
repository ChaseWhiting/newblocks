...
import net.mcreator.newblocks.entity.renderer.ZhoemnixRenderer;
...
public class ZhoemnixEntity extends NewBlocksModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.7999999999999999f, 1.8f)).build("zhoemnix").setRegistryName("zhoemnix");

	public ZhoemnixEntity(NewBlocksModElements instance) {
		super(instance, 1509);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ZhoemnixRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -12487383, -5982686, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("zhoemnix_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new PanicGoal(this, 1.7));
			this.goalSelector.addGoal(5, new MeleeAttackGoal(this, 1.7, false));
			this.goalSelector.addGoal(6, new PanicGoal(this, 1.8));
			...
			this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, WolfEntity.class, false, false) {
				@Override
				public boolean shouldExecute() {
					double x = CustomEntity.this.getPosX();
					double y = CustomEntity.this.getPosY();
			...
			this.targetSelector.addGoal(9, new NearestAttackableTargetGoal(this, WitchEntity.class, false, false) {
				@Override
				public boolean shouldExecute() {
					double x = CustomEntity.this.getPosX();
					double y = CustomEntity.this.getPosY();
			...
			this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, WaterMobEntity.class, false, false) {
				@Override
				public boolean shouldExecute() {
					double x = CustomEntity.this.getPosX();
					double y = CustomEntity.this.getPosY();
			...
			this.targetSelector.addGoal(12, new NearestAttackableTargetGoal(this, VillagerEntity.class, false, false) {
				@Override
				public boolean shouldExecute() {
					double x = CustomEntity.this.getPosX();
					double y = CustomEntity.this.getPosY();
			...
			this.goalSelector.addGoal(13, new TemptGoal(this, 1, Ingredient.fromItems(Blocks.WARPED_FUNGUS.asItem()), true));
			this.goalSelector.addGoal(14, new AvoidEntityGoal(this, PlayerEntity.class, (float) 2, 1.3, 1.6));
			this.goalSelector.addGoal(15, new AvoidEntityGoal(this, ZoglinEntity.class, (float) 6, 1.4, 1.7));
			this.goalSelector.addGoal(16, new AvoidEntityGoal(this, IronGolemEntity.class, (float) 6, 1.3, 1.6));
