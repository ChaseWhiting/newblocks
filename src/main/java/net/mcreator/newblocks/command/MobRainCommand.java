...
import net.mcreator.newblocks.procedures.MobRainCommandExecutedProcedure;
...
public class MobRainCommand {
	@SubscribeEvent
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("mobRain").requires(s -> s.hasPermissionLevel(4))
				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(arguments -> {
					...
					MobRainCommandExecutedProcedure.executeProcedure(
