...
import net.mcreator.newblocks.procedures.WhatisCommandExecutedProcedure;
...
public class WhatisCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("whatis")
				...
				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(arguments -> {
					...
					WhatisCommandExecutedProcedure.executeProcedure(
