...
import net.mcreator.newblocks.procedures.EnchantmeCommandExecutedProcedure;
...
public class EnchantmeCommand {
	@SubscribeEvent
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("enchantme").requires(s -> s.hasPermissionLevel(4))
				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(arguments -> {
					...
					EnchantmeCommandExecutedProcedure.executeProcedure(
