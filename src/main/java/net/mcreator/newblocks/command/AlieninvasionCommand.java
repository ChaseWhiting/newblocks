...
import net.mcreator.newblocks.procedures.AlieninvasionCommandExecutedProcedure;
...
public class AlieninvasionCommand {
	@SubscribeEvent
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("alieninvasion").requires(s -> s.hasPermissionLevel(4))
