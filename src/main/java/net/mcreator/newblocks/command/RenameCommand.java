...
import net.mcreator.newblocks.procedures.RenameCommandExecutedProcedure;
...
public class RenameCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("rename").requires(s -> s.hasPermissionLevel(4))
				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(arguments -> {
					...
					RenameCommandExecutedProcedure.executeProcedure(
