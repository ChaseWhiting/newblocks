...
public static class Modelphoenix_flying extends EntityModel<Entity> {
	...
	private final ModelRenderer bristle3_r1;
	...
	private final ModelRenderer bristle4_r1;
	...
	private final ModelRenderer hair_right_top_sub_2_r1;
	...
	private final ModelRenderer hair_right_bottom_sub_2_r1;

	public Modelphoenix_flying() {
		textureWidth = 128;
		textureHeight = 128;

		body = new ModelRenderer(this);
		body.setRotationPoint(0.0F, 1.0F, 0.0F);
		body.setTextureOffset(0, 117).addBox(-5.5F, 8.0F, -2.0F, 11.0F, 2.0F, 9.0F, 0.0F, false);

		saddle = new ModelRenderer(this);
		saddle.setRotationPoint(0.0F, -5.0F, 3.0F);
		body.addChild(saddle);
		saddle.setTextureOffset(0, 117).addBox(-5.5F, 13.0F, -5.0F, 11.0F, 2.0F, 9.0F, 0.0F, false);
		saddle.setTextureOffset(0, 114).addBox(-5.5F, 12.0F, 2.0F, 11.0F, 1.0F, 2.0F, 0.0F, false);

		bone11 = new ModelRenderer(this);
		bone11.setRotationPoint(0.0F, 28.0F, -3.0F);
		saddle.addChild(bone11);
		setRotationAngle(bone11, 0.0F, 0.3491F, 0.0F);
		bone11.setTextureOffset(40, 108).addBox(9.5F, -17.0F, -14.0F, 0.0F, 6.0F, 14.0F, 0.0F, false);

		bone5 = new ModelRenderer(this);
		bone5.setRotationPoint(-1.0F, 28.0F, 0.0F);
		saddle.addChild(bone5);
		setRotationAngle(bone5, 0.0F, -0.3491F, 0.0F);
		bone5.setTextureOffset(40, 108).addBox(-9.2F, -17.0F, -16.7F, 0.0F, 6.0F, 14.0F, 0.0F, false);

		bone14 = new ModelRenderer(this);
		bone14.setRotationPoint(0.0F, 23.0F, 0.0F);
		body.addChild(bone14);
		bone14.setTextureOffset(58, 97).addBox(-7.0F, -2.0F, -7.0F, 14.0F, 2.0F, 14.0F, 0.0F, false);
		bone14.setTextureOffset(0, 0).addBox(-8.0F, -12.0F, -8.0F, 16.0F, 10.0F, 16.0F, 0.0F, false);
		bone14.setTextureOffset(1, 97).addBox(-7.0F, -14.0F, -8.0F, 14.0F, 2.0F, 14.0F, 0.0F, false);
		...
		lilwing.setTextureOffset(72, 88).addBox(-11.6981F, 3.7503F, -7.5219F, 11.0F, 9.0F, 0.0F, 0.0F, false);
		...
		lilwing2.setTextureOffset(72, 78).addBox(-10.3955F, 4.3283F, 0.0162F, 11.0F, 9.0F, 0.0F, 0.0F, false);
		...
		tail4.setTextureOffset(96, 68).addBox(-23.2553F, 5.578F, 11.0614F, 7.0F, 0.0F, 9.0F, 0.0F, false);

		tail3 = new ModelRenderer(this);
		tail3.setRotationPoint(-1.0F, 0.0276F, 1.0304F);
		tail.addChild(tail3);
		setRotationAngle(tail3, -0.0519F, 0.346F, 0.258F);
		tail3.setTextureOffset(96, 77).addBox(1.0622F, 4.8974F, 4.9305F, 7.0F, 0.0F, 9.0F, 0.0F, false);

		tail2 = new ModelRenderer(this);
		tail2.setRotationPoint(0.0F, 0.0F, 0.0F);
		tail.addChild(tail2);
		setRotationAngle(tail2, -0.0873F, 0.0F, 0.0F);
		tail2.setTextureOffset(92, 95).addBox(0.0F, -0.848F, 4.4099F, 0.0F, 9.0F, 18.0F, 0.0F, false);

		bone4 = new ModelRenderer(this);
		bone4.setRotationPoint(0.0F, 0.0F, 0.0F);
		tail.addChild(bone4);
		bone4.setTextureOffset(57, 60).addBox(-7.5F, 7.6681F, 2.2302F, 15.0F, 0.0F, 18.0F, 0.0F, false);

		bone2 = new ModelRenderer(this);
		bone2.setRotationPoint(0.0F, -2.0F, -16.0F);
		body.addChild(bone2);
		bone2.setTextureOffset(64, 0).addBox(-4.0F, 7.3F, -5.2F, 8.0F, 7.0F, 8.0F, 0.0F, false);
		bone2.setTextureOffset(81, 30).addBox(0.0F, 4.3F, 0.8F, 0.0F, 12.0F, 9.0F, 0.0F, false);
		bone2.setTextureOffset(90, 17).addBox(-3.0F, 10.9F, -10.4F, 6.0F, 3.0F, 6.0F, 0.0F, false);

		bone7 = new ModelRenderer(this);
		bone7.setRotationPoint(0.0F, 16.0F, 9.0F);
		bone2.addChild(bone7);
		setRotationAngle(bone7, 0.0F, -0.2618F, 0.0F);
		bone7.setTextureOffset(81, 43).addBox(-4.1907F, -11.7011F, -7.4352F, 0.0F, 8.0F, 9.0F, 0.0F, false);

		bone6 = new ModelRenderer(this);
		bone6.setRotationPoint(0.0F, 16.0F, 9.0F);
		bone2.addChild(bone6);
		setRotationAngle(bone6, 0.0F, 0.2618F, 0.0F);
		bone6.setTextureOffset(81, 43).addBox(4.1907F, -11.7011F, -7.4352F, 0.0F, 8.0F, 9.0F, 0.0F, false);

		bone3 = new ModelRenderer(this);
		bone3.setRotationPoint(0.0F, 13.75F, 11.25F);
		bone2.addChild(bone3);
		setRotationAngle(bone3, 0.1309F, 0.0F, 0.0F);
		bone3.setTextureOffset(64, 15).addBox(-3.2F, -8.2198F, -22.2274F, 6.0F, 4.0F, 7.0F, 0.0F, false);
		bone3.setTextureOffset(58, 4).addBox(-3.2F, -6.9198F, -23.1274F, 6.0F, 3.0F, 1.0F, 0.0F, false);
		...
		brow2.setTextureOffset(63, 29).addBox(-4.6295F, -12.7481F, -8.2499F, 0.0F, 7.0F, 9.0F, 0.0F, false);

		brow = new ModelRenderer(this);
		brow.setRotationPoint(0.0F, 16.0F, 9.0F);
		bone2.addChild(brow);
		setRotationAngle(brow, 0.0873F, 0.1309F, 0.0873F);
		brow.setTextureOffset(63, 29).addBox(4.6295F, -12.7481F, -8.2499F, 0.0F, 7.0F, 9.0F, 0.0F, false);

		NECK = new ModelRenderer(this);
		NECK.setRotationPoint(8.0F, 4.0F, 9.0F);
		bone2.addChild(NECK);
		setRotationAngle(NECK, 0.0F, 0.0F, 1.0908F);
		NECK.setTextureOffset(16, 31).addBox(3.8214F, 7.4567F, -14.4F, 12.0F, 0.0F, 16.0F, 0.0F, false);
		...
		body_sub_5.setTextureOffset(16, 31).addBox(-18.5919F, 2.1346F, -14.4F, 12.0F, 0.0F, 16.0F, 0.0F, true);

		bone = new ModelRenderer(this);
		bone.setRotationPoint(0.0F, -3.0F, -6.75F);
		body.addChild(bone);
		setRotationAngle(bone, 1.4835F, 0.0F, 0.0F);
		bone.setTextureOffset(96, 0).addBox(-3.0F, -5.7837F, -16.2865F, 6.0F, 9.0F, 6.0F, 0.0F, false);
		...
		bone8.setTextureOffset(58, 102).addBox(-7.5875F, 1.4939F, 0.5229F, 7.0F, 9.0F, 0.0F, 0.0F, false);

		bone9 = new ModelRenderer(this);
		bone9.setRotationPoint(8.0F, 6.75F, 2.0F);
		fronhair.addChild(bone9);
		setRotationAngle(bone9, -0.2065F, -0.2221F, -0.0385F);
		bone9.setTextureOffset(58, 93).addBox(-2.8804F, 1.3418F, -10.9978F, 7.0F, 9.0F, 0.0F, 0.0F, false);

		bone10 = new ModelRenderer(this);
		bone10.setRotationPoint(8.0F, 1.5F, -10.5F);
		fronhair.addChild(bone10);
		setRotationAngle(bone10, -0.2182F, 0.0F, 0.0F);
		bone10.setTextureOffset(72, 88).addBox(-4.0F, 7.6207F, 4.163F, 8.0F, 9.0F, 0.0F, 0.0F, false);

		left_leg = new ModelRenderer(this);
		left_leg.setRotationPoint(4.0F, 7.0F, 0.0F);
		setRotationAngle(left_leg, 1.0472F, 0.0F, 0.0F);
		left_leg.setTextureOffset(0, 55).addBox(-8.0F, 15.0F, -10.1244F, 0.0F, 0.0F, 0.0F, 0.0F, false);

		left_leg2 = new ModelRenderer(this);
		left_leg2.setRotationPoint(-8.0F, 1.0F, 0.0F);
		left_leg.addChild(left_leg2);
		left_leg2.setTextureOffset(0, 32).addBox(-2.0F, 7.0F, -14.1244F, 4.0F, 16.0F, 4.0F, 0.0F, false);
		left_leg2.setTextureOffset(16, 45).addBox(-1.0F, 21.0F, -16.1244F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		left_leg2.setTextureOffset(17, 53).addBox(-1.0F, 21.0F, -10.1244F, 2.0F, 2.0F, 1.0F, 0.0F, false);
		left_leg2.setTextureOffset(16, 49).addBox(1.0F, 21.0F, -15.1244F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		left_leg2.setTextureOffset(16, 49).addBox(-3.0F, 21.0F, -15.1244F, 2.0F, 2.0F, 2.0F, 0.0F, false);

		right_leg = new ModelRenderer(this);
		right_leg.setRotationPoint(-4.0F, 7.0F, 0.0F);
		setRotationAngle(right_leg, 1.0472F, 0.0F, 0.0F);
		right_leg.setTextureOffset(0, 32).addBox(6.0F, 17.0F, -10.1244F, 0.0F, 0.0F, 0.0F, 0.0F, false);

		right_leg2 = new ModelRenderer(this);
		right_leg2.setRotationPoint(8.0F, 1.0F, 0.0F);
		right_leg.addChild(right_leg2);
		right_leg2.setTextureOffset(0, 32).addBox(-2.0F, 7.0F, -14.1244F, 4.0F, 16.0F, 4.0F, 0.0F, false);
		right_leg2.setTextureOffset(16, 45).addBox(-1.0F, 21.0F, -16.1244F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		right_leg2.setTextureOffset(17, 53).addBox(-1.0F, 21.0F, -10.1244F, 2.0F, 2.0F, 1.0F, 0.0F, false);
		right_leg2.setTextureOffset(16, 49).addBox(1.0F, 21.0F, -15.1244F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		right_leg2.setTextureOffset(16, 49).addBox(-3.0F, 21.0F, -15.1244F, 2.0F, 2.0F, 2.0F, 0.0F, false);
		...
		hair_left_top_rotation.setTextureOffset(4, 33).addBox(19.1244F, 7.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.0F, false);

		bristle3 = new ModelRenderer(this);
		bristle3.setRotationPoint(0.0F, 1.0F, 0.0F);
		hair_left_top_rotation.addChild(bristle3);

		bristle3_r1 = new ModelRenderer(this);
		bristle3_r1.setRotationPoint(5.0F, 19.0F, 0.0F);
		bristle3.addChild(bristle3_r1);
		setRotationAngle(bristle3_r1, 0.0F, 0.0F, -0.7418F);
		bristle3_r1.setTextureOffset(12, 47).addBox(10.536F, -1.5116F, -8.0F, 14.0F, 0.0F, 20.0F, 0.0F, false);
		...
		hair_left_middle_rotation.setTextureOffset(4, 49).addBox(12.1244F, 7.0F, -8.0F, 0.0F, 0.0F, 0.0F, 0.0F, false);
		...
		hair_left_bottom_rotation.setTextureOffset(4, 65).addBox(12.1244F, 7.0F, 2.0F, 0.0F, 0.0F, 6.0F, 0.0F, false);

		bristle4 = new ModelRenderer(this);
		bristle4.setRotationPoint(0.0F, -4.0F, 3.0F);
		hair_left_bottom_rotation.addChild(bristle4);

		bristle4_r1 = new ModelRenderer(this);
		bristle4_r1.setRotationPoint(-8.0F, 24.0F, -3.0F);
		bristle4.addChild(bristle4_r1);
		setRotationAngle(bristle4_r1, 0.0F, 0.0F, -0.6109F);
		bristle4_r1.setTextureOffset(9, 67).addBox(18.9167F, -2.8476F, -6.0F, 16.0F, 0.0F, 23.0F, 0.0F, false);
		...
		hair_right_top_rotation.setTextureOffset(4, 33).addBox(-19.1244F, 7.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.0F, true);
		...
		hair_right_top_sub_2_r1 = new ModelRenderer(this);
		hair_right_top_sub_2_r1.setRotationPoint(-4.0F, 20.0F, 0.0F);
		hair_right_top_sub_2.addChild(hair_right_top_sub_2_r1);
		setRotationAngle(hair_right_top_sub_2_r1, 0.0F, 0.0F, 0.7418F);
		hair_right_top_sub_2_r1.setTextureOffset(12, 47).addBox(-24.5739F, -1.6738F, -8.0F, 14.0F, 0.0F, 20.0F, 0.0F,
				true);
		...
		hair_right_middle_rotation.setTextureOffset(4, 49).addBox(-12.1244F, 7.0F, -8.0F, 0.0F, 0.0F, 0.0F, 0.0F, true);
		...
		hair_right_bottom_rotation.setTextureOffset(4, 65).addBox(-18.1244F, 7.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, true);
		...
		hair_right_bottom_sub_2_r1 = new ModelRenderer(this);
		hair_right_bottom_sub_2_r1.setRotationPoint(8.0F, 24.0F, -4.0F);
		hair_right_bottom_sub_2.addChild(hair_right_bottom_sub_2_r1);
		setRotationAngle(hair_right_bottom_sub_2_r1, 0.0F, 0.0F, 0.5672F);
		hair_right_bottom_sub_2_r1.setTextureOffset(9, 67).addBox(-34.9645F, -3.5017F, -7.0F, 16.0F, 0.0F, 23.0F, 0.0F,
				true);
	}
