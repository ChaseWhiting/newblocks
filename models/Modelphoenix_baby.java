...
public static class Modelphoenix_baby extends EntityModel<Entity> {
	...
	public Modelphoenix_baby() {
		...
		hair_right_middle_rotation.setTextureOffset(4, 49).addBox(-4.9797F, 2.875F, -8.0F, 0.0F, 0.0F, 0.0F, 0.0F,
				true);
		...
		hair_right_bottom_rotation.setTextureOffset(4, 65).addBox(-10.9797F, 2.875F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F,
				true);
		...
		hair_right_bottom_sub_2.setTextureOffset(9, 67).addBox(-18.4797F, 6.2051F, -8.0F, 16.0F, 0.0F, 23.0F, 0.0F,
				true);
	}
